...
class gen_e3_t{
  ...
  private:
    ...
    string lfsr1_,lfsr2_,lfsr3_,lfsr4_,lfsr5_;
    string r1_,r2_;
  ...
  gen_e3_t()
  {
    ...
    lfsr5_ = "111111111111111111111111111111111111111";
    r1_ = "01";
  }
  ...
  void codificacion_bt(int n_b_salida)
  {
    ...
    for(int i = 0; i < n_b_salida;i++)
    {
      ...
      r2_ =  r1_;
      swap(r1_[0],r1_[1]);
      resultado.insert(0,calc_resultado(lfsr1_.back(),lfsr2_.back(),lfsr3_.back(),lfsr4_.back(),r1_[1],lfsr5_.back()));
      t2();
  ...
  void lfsr(void)
  {
    ...
    int lfsr5 = sumar_lfsr(lfsr5_[36],lfsr5_[14],lfsr5_[13],lfsr5_[7]);
  ...
  string calc_resultado(char l1,char l2,char l3,char l4,char l5,char l6)
  {
    int r = 0;
    if(l1=='1')
      r++;
